...
const Quote = () => {
  ...
  return (
    <div className="pt-16 min-h-screen bg-gray-50">
      ...
      <section 
        ref={headerRef}
        className={`py-20 bg-gradient-to-r from-blue-900 to-gray-800 text-white transition-all duration-1000 ${
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
              ...
              <div className="p-6">
                <div className="aspect-[4/5] w-full">
                  <iframe
                    src="https://docs.google.com/forms/d/e/1FAIpQLScgULd63BqC0EfhUNntbaOjj3-GfHHDeqTbNQAM9EJImRfQsQ/viewform?usp=header"
                    width="100%"
                    height="100%"
                    frameBorder="0"
                    marginHeight={0}
                ...
                <div className="mt-6 text-center">
                  <a
                    href="https://forms.gle/XxyGYJ9EX8YXydXb6"
                    target="_blank"
