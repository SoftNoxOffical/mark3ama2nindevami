    ...
    <div className="pt-16">
      ...
      >
        <div className="absolute inset-0">
          ...
          <img
            src="https://images.pexels.com/photos/5708977/pexels-photo-5708977.jpeg"
            alt="Ürünlerimiz"
        ...
        <div className="relative z-20 text-center text-white max-w-4xl mx-auto px-4">
          ...
          <p className="text-xl opacity-90">
            Kaliteli ve çeşitli bez ürün koleksiyonumuzu keşfedin
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {productCategories.map((product, index) => (
              <div
                key={product.id}
                className={`bg-white rounded-2xl shadow-xl overflow-hidden group hover:shadow-2xl transition-all duration-500 transform hover:scale-105 ${
